function [data] = vector_quantisation_rf(classList, folderName, nSamples, nClusters, imgIdxSet, forest, descriptor, type, showImg)
% Function:
...
for iClass = 1: nClasses
    ...
    for iSample = 1: nSamples
        ...
        index = testTrees_fast(descCurr', forest);
